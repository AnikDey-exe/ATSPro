...
dirpath = r'C:\Users\manas\Dropbox\My PC (LAPTOP-OEFAVRL0)\Downloads\archive (2)'
file_type = ".csv"
filenames = []
data = []

dirpath2 = r'C:\Users\manas\Dropbox\My PC (LAPTOP-OEFAVRL0)\Downloads\archive (3)\allJobs.csv'
data2 = []

df = pd.read_csv(dirpath2)

for index, row in df.iterrows():
    data2.append(row['Job-Title'] + " " + row['Description'])
